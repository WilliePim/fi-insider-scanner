...
OBSERVED_KARAKTAR = [
    "Förvärv", "Avyttring", "Teckning", "Tilldelning", "Lösen minskning", "Lösen ökning", "Gåva mottagen",
    "Lån utlåning", "Gåva lämnad", "Lån återgång ökning", "Utbyte ökning", "Utbyte minskning",
    "Konvertering ökning", "Utdelning mottagen", "Konvertering minskning", "Lån mottaget",
    "Inlösen egenutfärdat instrument", "Utfärdande av instrument", "Pantsättning", "Lån återgång minskning",
    "Fusion ökning", "Interntransaktion – Avyttring", "Interntransaktion – Förvärv", "Utdelning lämnad",
    "Pantsättning åter", "Koncernintern överföring ökning", "Koncernintern överföring minskning",
    "Fusion minskning", "Arv mottagen", "Arv ökning", "Koncernintern överföring förvärv",
    "Koncernintern överföring avyttring", "Bodelning minskning", "Fission ökning", "Fission minskning",
    "Bodelning ökning", "Arv minskning", "Arv lämnad", "Bodelning avyttring", "Blankning", "Bodelning förvärv",
]
