"""Checkpoint 6b: the pre-registration. Written and committed before any forward return is computed."""
...
Scritta il {datetime.now(UTC).isoformat(timespec="seconds")}, **prima** di calcolare qualsiasi rendimento successivo agli eventi.
